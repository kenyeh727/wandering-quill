...
export const CvView: React.FC<CvViewProps> = ({ content, onApprove, onRegenerate, isGenerating }) => {
  return (
    <div className="max-w-4xl mx-auto h-[calc(100vh-12rem)] flex flex-col animate-in fade-in zoom-in-95 duration-500">
      <div className="text-center mb-6 shrink-0">
        <h2 className="text-3xl font-display font-bold text-[#2c3e50]">The Reforged Shield</h2>
        <p className="text-[#637b89] italic">A tailored resume to match your quest. Review it before proceeding.</p>
      </div>
