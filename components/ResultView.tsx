      ...
      <div className="flex flex-col border-b border-[#d4c5b0] bg-[#fffdf5]">
        ...
        <div className="flex px-6 gap-2">
          <button
            ...
            className={`px-4 py-2 text-sm font-bold uppercase tracking-wide rounded-t-lg transition-colors border-t border-l border-r ${activeTab === 'resume'
          ...
          <button
            ...
            className={`px-4 py-2 text-sm font-bold uppercase tracking-wide rounded-t-lg transition-colors border-t border-l border-r ${activeTab === 'coverLetter'
              ? 'bg-[#fdf6e3] border-[#d4c5b0] text-[#2b5876] -mb-[1px] relative z-10'
              : 'bg-[#f0f0f0] border-transparent text-[#637b89] hover:bg-[#e6e6e6]'
              }`}
          >
