...
export const ProfileForm: React.FC<ProfileFormProps> = ({ data, onChange, onNext, language }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="text-center mb-8">
        <h2 className="text-3xl font-display font-bold text-[#2c3e50] mb-2">{t.profileTitle}</h2>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-8">
        ...
        {!isCreating ? (
          ...
          >
            ...
            <span className="text-xs font-bold uppercase tracking-widest text-[#637b89] group-hover:text-[#c5a059]">{t.createNew}</span>
          </button>
        ) : (
          <div className="col-span-1 md:col-span-2 bg-[#fffdf5] border-2 border-[#c5a059] rounded-xl p-4 flex flex-col justify-center animate-in zoom-in-95">
            <label className="text-[10px] font-bold uppercase tracking-widest text-[#c5a059] mb-1">{t.nameHero}</label>
      ...
      <div className={`bg-[#fffdf5] p-8 rounded-xl border-2 shadow-xl relative overflow-hidden transition-colors duration-500 
        ...
        <div className="space-y-6 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className={labelClass}>{t.candidateName}</label>
              <input
                type="text"
